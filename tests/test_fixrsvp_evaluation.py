...
from paper.model_selection._fixrsvp_protocol import (
...
from paper.model_selection.evaluate_fixrsvp import (
...
def test_representative_examples_cover_typical_and_model_advantage_cases():
    ...
    chosen = _representative_examples([result], [reference_model], n_examples=4)

    assert [row[0] for row in chosen] == [
        "strong candidate",
        "typical",
        "candidate advantage",
        "reference-model advantage",
    ]
