...
from DataYatesV1 import (
    ...
    get_complete_sessions, print_batch, set_seeds, calc_sta, YatesV1Session
)

# TODO: implement from RowleyDataV1V2
...
def process_session_config(sess, base_config, output_dir, snr_thresh, missing_thresh, contam_thresh, n_lags=24):
    ...
    if isinstance(sess, YatesV1Session):
...
all_stats = []
for sess in tqdm(all_sessions, desc="Processing sessions"):
    try:
