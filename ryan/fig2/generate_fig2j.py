"""
Figure 2 panel J: participation-ratio scatter (FEM vs PSTH), one point per
...
def plot_panel_j(ax=None, refresh=False, data=None):
    if data is None:
...
if __name__ == "__main__":
    fig, ax = plot_panel_j()
    fig.tight_layout()
    standalone_save(fig, "panel_j_participation_ratio")
