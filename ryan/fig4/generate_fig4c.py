"""Figure 4 panel C: single-trial rasters (observed | twin) for example neuron.
...
def plot_panel_c(ax=None, data=None, example=None,
...
if __name__ == "__main__":
    ...
    fig, ax, im, _ = plot_panel_c()
    out = FIG_DIR / "panel_c_rasters.pdf"
