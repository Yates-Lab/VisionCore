...
\reviewedit{FEMs accounted for most of the conditional rate modulation in the recorded population.} FEMs accounted for 70\% of the rate modulation in individual neurons, significantly more than the stimulus-locked average response. Conventional measures of residual variability were substantially reduced, and \reviewedit{FEM-driven variance was concentrated in a few dominant dimensions that overlapped those of the stimulus-driven response}. \reviewedit{An encoding model predicted much of the single-trial modulation from retinal input, with a smaller additional contribution from its explicit eye-state pathway, providing predictive evidence for a substantial reafferent contribution.}

Visual information was increased by FEMs in select neural subpopulations, depending on the metrics of the eye movement and the stimulus content. Real FEMs produced more informative activations than counterfactually stabilized \reviewedit{input, reconstructed at a fixed gaze position to preserve stimulus changes while removing eye-induced retinal motion.} Further, the size of the FEMs interacted with both the tuning of the neurons and the stimulus content to increase stimulus information dynamically as a function of the gaze trajectory. These model analyses test how the interaction between receptive-field tuning and eye motion shapes the spatial information carried by the population response.
...
\textbf{D}, Log$_2$ microsaccade/drift power ratio with the example passbands overlaid, \reviewedit{showing their overlap with the redistributed retinal power}.
