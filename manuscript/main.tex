...
In natural settings sensation is inseparable from action. An animal's own movements continually shape the signals arriving at their sensory receptors, so neural activity depends not only on external stimuli, but also on the recent history of movements made by the animal. Vision provides an unusually precise instance of this problem. The eyes are never at rest \cite{Jurin1738, martinez2017unchanging}, and fixational eye movements (FEMs), including drift and microsaccades, continually translate the image across the retina. Decades of psychophysical work show that these minute displacements support fine spatial vision \cite{rucci2007miniature, ratnam2017benefits, intoy2020finely}. Retinal motion converts spatial structure into temporal modulation, and theoretical work treats this temporal signal as a carrier of spatial information \cite{rucci2015unsteady, rucci2018temporal, ahissar2012seeing} that can be read out to resolve detail finer than the cone mosaic alone would permit \cite{anderson2020high, assa2026temporal}. Consistent with this account, neurophysiological studies have found substantial effects of FEMs in the retina \cite{wu2024fixational} and primary visual cortex (V1) \cite{snodderly2001selective, kagan2008saccades, baudot2013animation, mcfarland2016variability}. Yet how this self-generated retinal motion shapes visual encoding across cortical populations remains unknown.

Resolving this requires measuring both how strongly FEMs affect cortical activity and how the resulting activity is structured relative to the stimulus-driven population response. Conventional analyses treat repeated presentations of the same displayed stimulus as repeated samples of the same input, assigning trial-to-trial differences in response to residual variability \cite{tolhurst1983statistical, shadlen1998variable}. During fixation, this assumption can fail: FEMs dynamically change the retinal image even when the displayed stimulus is repeated \cite{mcfarland2016variability}. Analyses that are blind to eye position therefore leave differences in retinal input within the residual, together with whatever variability remains after the retinal input is fixed. Separating these components is necessary to interpret estimates of response reliability and their underlying mechanisms \cite{tolhurst1983statistical, softky1993highly, shadlen1998variable, gur1997response}. The population structure of the FEM-dependent component is equally important. Independent fluctuations can be averaged away across neurons, whereas shared fluctuations can enhance, impair, or limit coding depending on their alignment with neuronal tuning \cite{averbeck2006neural, moreno2014information}. The magnitude and nature of such correlated fluctuations remains contentious \cite{cohen2011measuring}. Thus, understanding how FEMs influence visual processing requires determining both the amount of cortical population activity they drive and whether that activity occupies the same dimensions as the stimulus-driven response.

The potential effects of FEMs are especially consequential in the primate fovea, which subtends the $\sim$5-8 deg of visual angle across species \cite{franco2000conservation}, supports the highest spatial acuity, and is disproportionately represented in V1 \cite{fritsches1996visuotopic}. FEMs can displace the image by amounts comparable to the size of receptive fields of individual foveal neurons. We therefore measured neural variability across ensembles of neurons in the foveal representation of marmoset V1 during alert fixation of naturalistic images. This required resolving eye movements small enough to shift image features across foveal receptive fields, which we did with a digital dual Purkinje image eye tracker \cite{yates2023detailed, wu2023high, ressmeyer2025openirisdpi}. By repeatedly presenting a fixed sequence of naturalistic images, while measuring the cortical response and the eye’s unique trajectory on each presentation, we were able to partition the variability into stimulus-locked, FEM-dependent, and residual components.



% We presented repeated sequences of flashed natural images to quantify how differences in retinal input contribute to response variability while holding the displayed stimulus sequence fixed. The potential effects of FEMs are especially consequential in the fovea, where they can displace the image by amounts comparable to the receptive fields of individual neurons and where primates concentrate their highest acuity. We therefore measured neural variability in the foveal representation of marmoset V1 during alert fixation, recording populations of neurons while tracking gaze with a digital dual Purkinje image eye tracker \cite{yates2023detailed, ressmeyer2025openirisdpi, wu2023high}. This required resolving eye movements small enough to shift image features across foveal receptive fields. Measuring the cortical response and the eye's trajectory on the same trials let us ask how much apparent variability the eye accounts for and how that variability is arranged relative to the stimulus-driven response. We addressed both questions with a decomposition based on the law of total covariance, which partitions population variability into stimulus-locked, FEM-dependent, and residual components.

% % Vision is active, even during fixation. 
% We have known for centuries that the eyes never rest \cite{Jurin1738, martinez2017unchanging}, and fixational eye movements \reviewedit{(FEMs), including drift and microsaccades,} continually translate the image across the retina. Decades of psychophysical work show that these minute displacements support fine spatial vision \cite{rucci2007miniature, ratnam2017benefits, intoy2020finely}. Retinal motion converts spatial structure into temporal modulation, and theoretical work treats this temporal signal as a carrier of spatial information \cite{rucci2015unsteady, rucci2018temporal, ahissar2012seeing} that can be read out to resolve detail finer than the cone mosaic alone would permit \reviewedit{\cite{anderson2020high,assa2026temporal}}. Consistent with this account, neurophysiological studies have found substantial effects of FEMs in the retina \cite{wu2024fixational} and visual cortex \reviewedit{\cite{snodderly2001selective, kagan2008saccades, baudot2013animation, mcfarland2016variability}}. Yet how these movements shape visual encoding across cortical populations remains unknown.

% The influence of FEMs on visual encoding depends on the magnitude and structure of their effect on cortical population activity. FEMs dynamically change the \reviewedit{retinal image}, even when the visual stimulus is repeated \cite{mcfarland2016variability}. \reviewedit{Conventional analyses quantify variability across repetitions of the displayed stimulus, leaving differences in retinal input within the residual alongside internally generated variability} \cite{tolhurst1983statistical, shadlen1998variable}. \reviewedit{Separating these retinal-input differences from the remaining variability is necessary to interpret estimates of response reliability and their underlying mechanisms} \cite{tolhurst1983statistical, softky1993highly, shadlen1998variable, gur1997response}. At the population level, theoretical work has clarified that independent fluctuations can be averaged away across neurons, whereas shared fluctuations can enhance, impair, or limit coding depending on their alignment with neuronal tuning \cite{averbeck2006neural, moreno2014information}. The magnitude and nature of such correlated fluctuations remains contentious \cite{cohen2011measuring}. Neither the amount of cortical activity driven by FEMs nor its alignment with the stimulus-driven population response has been definitively characterized with respect to effects on visual processing.
...
% We \reviewedit{presented repeated sequences of flashed natural images to quantify how differences in retinal input contribute to response variability while holding the displayed stimulus sequence fixed.} The potential effects of FEMs are most consequential in the fovea, where they can displace the image by amounts comparable to the receptive fields of individual neurons and where primates concentrate their highest acuity. We therefore measured neural variability in the foveal representation of marmoset V1 during alert fixation, recording populations of neurons while tracking gaze with a digital dual Purkinje image eye tracker \cite{yates2023detailed, ressmeyer2025openirisdpi, wu2023high}. \reviewedit{This required resolving eye movements small enough to shift image features across foveal receptive fields. Measuring} the cortical response and the eye's trajectory on the same trials let us ask how much of the variability the eye accounts for and how that variability is arranged relative to the stimulus-driven response. We addressed both with a decomposition based on the law of total covariance, which partitions population variability into stimulus-locked, FEM-dependent, and residual \reviewedit{components.}

FEM-induced changes in the retinal image accounted for the majority of the conditional rate modulation in the recorded V1 population. FEMs accounted for 70\% of the rate modulation in individual neurons, significantly more than the stimulus-locked average response. Conventional measures of residual variability (``noise'') were substantially reduced, and FEM-driven variance was concentrated in a few dominant dimensions that overlapped those of the stimulus-driven response. An encoding model predicted much of the single-trial modulation from precisely-measured retinal input, with a much smaller additional contribution from an explicit eye-state pathway.

This active mechanism increased visual information in select neural subpopulations, depending on the metrics of the eye movement, the stimulus content, and the spatiotemporal tuning of the neurons. Using our detailed predictive model, FEMs produced more informative activations than counterfactually stabilized input. Furthermore, analysis of the model revealed that nonlinear elements of visual processing contributed to the sharpening of visual signalling, beyond that expected by the temporal modulations introduced by FEMs. Together, these results demonstrate the fundamental role of active sensing in foveal vision: fine-scale movements of the sensor reshape the afferent input it receives (termed ``reafference''). Reafference has been demonstrated as a key element of active sensing in other sensory modalities; our results here show it plays a central and ubiquitous role in the highest-acuity form of vision.
%reconstructed at a fixed gaze position to preserve stimulus changes while removing eye-induced retinal motion. 
%Further, the size of the FEMs interacted with both the tuning of the neurons and the stimulus content to increase stimulus information dynamically as a function of the gaze trajectory. These model analyses test how the interaction between receptive-field tuning and eye motion shapes the spatial information carried by the population response.
...
From these, we computed the fraction of the conditional rate variance attributable to fixational eye movements, $f_{\text{FEM}}$ (Fig.~2B), which had a median of $\FigTwoFemMedian$ across the population (IQR $\FigTwoFemIQR$; $n=\FigTwoFemUnits$ units; Fig.~2C). Neural responses therefore varied more with trial-to-trial differences in eye position than with the stimulus itself, despite tight behavioral control. 
...
The decomposition additionally separates conditional rate covariance from residual covariance across simultaneously recorded units (Methods). The latter defines the FEM-corrected residual correlations, conventionally termed ``noise correlations''. Doing so partitions the total covariance into a stimulus-locked component ($\Cpsth$), an eye-movement--dependent component ($\Cfem$), and a residual ($\Sigma_{\text{res}}$), where the conventional residual is the sum of the latter two ($\Sigma_{\text{res}, \text{unc}} = \Cfem + \Sigma_{\text{res}}$; Fig.~2D). Under this decomposition, the off-diagonal structure present in the conventional residual migrated almost entirely into $\Cfem$, leaving $\Sigma_{\text{res}}$ near-diagonal. Without consideration of FEMs, noise correlations were $\FigTwoNCUncorrected$ (95\% CI $\FigTwoNCUncorrectedCI$), comparable to previous reports \cite{smith2008spatial, mitchell2009spatial}, But with FEM correction, noise correlations fell to $\FigTwoNCCorrected$ (95\% CI $\FigTwoNCCorrectedCI$), an interval including zero ($\Delta r = \FigTwoNCDifference$ (95\% CI $\FigTwoNCDifferenceCI$) vs.\ a shuffle null of $\FigTwoNCNullCI$, empirical $p \leq 0.001$; Fig.~2F). Differences in eye position across trials thus account for almost all of the shared variability left by the trial-averaged response.

FEM-driven variance was also concentrated in a few dominant population dimensions. Its participation ratio averaged $\FigTwoPRFem$ across sessions, roughly seven-fold more compact than the residual ($\FigTwoPRResidual$) and not detectably different from the stimulus-locked covariance $\Cpsth$ ($\FigTwoPRStimulus$; sign test, 12 of 19 sessions, $p = \FigTwoPRSignP$; Fig.~2G). With much of the variance in both components concentrated in a few dimensions, those dimensions could overlap or be largely distinct. Both arrangements are plausible. Changes in the displayed image and eye movements both alter the visual features falling within neuronal receptive fields, potentially recruiting similar population response patterns and aligning the dominant dimensions. However, a neuron's responsiveness across images need not predict its sensitivity to displacements of the stimulus. Small translations may strongly modulate neurons whose receptive-field subregions lie near image boundaries while leaving other visually responsive neurons relatively unaffected. FEM-driven variability could therefore occupy dimensions distinct from those dominating the stimulus-locked response. We therefore asked whether the dominant population dimensions of these two covariance components aligned.

We quantified this alignment by projecting each covariance component onto the leading eigenvectors of its counterpart and computing the fraction of variance retained (Fig.~2H; Methods). Larger fractions indicate that more of one component's variance lies within the dominant dimensions of the other. Because this measure is asymmetric, we evaluated both directions, each against a shuffle null that destroyed the trial-specific coupling between eye position and population activity. A majority of the stimulus-locked variance fell within the FEM subspace ($\FigTwoStimInFem$), and a majority of the FEM-driven variance fell within the stimulus-locked subspace ($\FigTwoFemInStim$), each well above its shuffle null ($\approx 0.35$; $p \leq 0.001$ for both directions; Fig.~2I). FEM-driven modulation therefore overlaps the dominant dimensions of the stimulus-locked population response. 
...
\begin{figure}[t]
  ...
  \textbf{(B)} Model architecture and input interventions. Retinal input enters the model as a XX deg movie patch which follows the gaze of the animal over time. This input is then filtered by a set of 14 frontend filters. A shared feedforward core combines three spatial stages into a multiscale representation, with behavioral gain and appended additive features before factorized unit readouts and a softplus link. Colored labels identify the conditions in C--E: Full (blue) retains measured retinal motion and extraretinal input; Retinal only (red) retains retinal motion but sets the extraretinal input to zero; Stabilized (ochre) removes gaze-induced retinal motion while retaining extraretinal input. All conditions use the same fitted weights. Retinal histories comprise $35\times35$ pixels and 60 frames (250~ms).  Stage labels give feature-map dimensions and channel counts. Filter planes show learned filters at their peak-energy lag; readout glyphs illustrate spatial--feature factorization. Separate FixRSVP examples show the eye-position and velocity traces and a held-out PSTH with recorded (gray) and Full-model (blue) rates.
