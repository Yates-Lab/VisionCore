...
The historical RR100 population contains channels defined from Ryan's
...
All Ryan comparisons use identical observations and data-defined support. The
...
contexts, Ryan's exemplar Jacobians are visibly checkerboarded and roughly an
...
The gradient subspace is useful but not a low-rank surrogate. Rank 8 captures
0.3578 of Jacobian energy and explains median held-out response R2 0.3204
(minimum 0.2189). Rank 16 captures 0.4886 of Jacobian energy and explains
median response R2 0.3247. No tested rank reaches the deliberately stringent
0.8 surrogate gate.
...
- Focused native-240/Figure-3/Figure-4 regression suite: 205 passed.
- Repository suite excluding the pre-existing script-style
  `tests/test_frozencore_pipeline.py`: 549 passed, 1 skipped.
- Relevant source trees compile successfully.
