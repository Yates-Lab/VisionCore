#!/usr/bin/env python3
"""Render an audited Twin-versus-native-240 production comparison.
...
The Twin and the candidate are rescored with one explicit data-only support and
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--reference-label", default="Twin")
