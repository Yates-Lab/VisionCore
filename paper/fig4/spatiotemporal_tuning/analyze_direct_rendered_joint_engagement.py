#!/usr/bin/env python3
"""Measure a model's SF×TF engagement from exactly rendered movies.
...
def render_population_summary(
    ...
    figure.suptitle(
        "Retinal power measured from the actually rendered movies",
        fontsize=13,
        fontweight="semibold",
    )
...
def main() -> int:
    ...
    figure = args.out_dir / "direct_rendered_population_summary.png"
