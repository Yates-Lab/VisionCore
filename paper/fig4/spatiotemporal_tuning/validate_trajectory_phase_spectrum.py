...
def main() -> int:
    ...
    summary = {
        "analysis": "M77 ideal trajectory-phase spectrum versus exact rendered retinal movies",
        ...
        "claim_boundary": "Agreement validates the ideal pure-translation phase-carrier approximation against the exact finite crop, bilinear interpolation, and zero padding for the sampled M77 retinal movies. It does not validate direction pooling or any downstream neural interpretation.",
