...
def population_unit_rows(population_view: Any, canonical_unit_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for unit_index in range(int(population_view.n_units)):
        ...
        row: dict[str, Any] = {
            ...
            "rr100_active": bool(input_channel is not None),
        }
    ...
    def load(
        ...
        *,
        ...
        provenance = {
            ...
            "rr100_checkpoint_availability": availability_report,
...
class LegacyCanonicalTwinScorerAdapter:
    """Run the recovered production unit-map analysis with a selected twin.
    ...
    movie selection, trace manipulation, RR100 projection, SSI calculation,
    ...
    def __init__(
        ...
        *,
        ...
        self.population_source = "selected_twin_canonical_shared_population_readout"
        self.model_family = str(
            scorer.provenance.get("model", {}).get("model_family", "selected_twin")
        )
