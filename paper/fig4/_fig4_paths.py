...
REFRESH_SOURCES = {
    ...
    BRIDGE_PREDICTION_BY_COHERENCE_SUMMARY_CSV: "_fig4_bridge_by_coherence.py",
    BRIDGE_MATCH_NULL_SUMMARY_CSV: "_fig4_bridge_rotation_null.py",
    ...
    STORY_COMPONENT_VALUES_CSV: "_fig4_geometry_story_cde8bins.py",
    STORY_PANEL_B_VALUES_CSV: "_fig4_orientation_match_sf05.py",
