...
for session in tqdm(get_complete_sessions(), desc='Processing sessions'):
    try:
        ...
        fig.savefig(f'tiled_rasters/tiled_rasters_{subject}_{date}.pdf', dpi=400, bbox_inches='tight')
...
# os.makedirs(f'tiled_rasters', exist_ok=True)
fig.savefig(f'tiled_rasters_{subject}_{date}_416ms.pdf', dpi=400, bbox_inches='tight')
