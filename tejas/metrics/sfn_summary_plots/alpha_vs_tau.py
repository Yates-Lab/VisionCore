...
#%%
x_variable = 'alpha_data_10_bins'
y_variable = 'tau_data_10_bins'
...
for mode in modes_to_highlight:
    # mode = 'further_from_y_axis'
    save_to_one_pdf = True
    dir = f'/mnt/ssd/YatesMarmoV1/metrics/sfn_summary_plots/{x_variable}_vs_{y_variable}'
    Path(dir).mkdir(parents=True, exist_ok=True)
    pdf_path = Path(dir) / f'{mode}_units.pdf'
    if save_to_one_pdf:
