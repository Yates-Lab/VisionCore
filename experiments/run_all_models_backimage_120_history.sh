...
# Batch training script to run spike history model configurations sequentially.
...
PROJECT_NAME="multidataset_backimage_120_history"
...
MODEL_CONFIGS=(
    "experiments/model_configs/learned_dense_concat_convgru_gaussian_history.yaml"
)
...
# Main execution
echo "============================================================"
echo "BATCH TRAINING: SPIKE HISTORY MODEL CONFIGURATIONS"
echo "============================================================"
