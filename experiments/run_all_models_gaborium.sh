...
PROJECT_NAME="multidataset_gaborium_120"

DATASET_CONFIGS_PATH="/mnt/ssd/YatesMarmoV1/conv_model_fits/experiments/multidataset/dataset_gaboriumonly_multi_120"
...
MODEL_CONFIGS=(
    ...
    "configs_multi/learned_res_small_none_gru.yaml"
...
run_training() {
    ...
    # Launch training
    uv run python training/train_ddp_multidataset.py \
        --model_config "$MODEL_CONFIG" \
        --dataset_configs_path "$DATASET_CONFIGS_PATH" \
